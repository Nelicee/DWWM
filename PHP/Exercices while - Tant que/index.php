...
// avec ce code je sors de la boucle
// $nbre = readline("Merci de taper un nombre compris entre 10 et 20: ");
// while ($nbre > 20){
//     $nbre = readline("Plus petit"); 
// }
// while ($nbre < 10) {
//     $nbre = readline("Plus grand"); 
// }
// echo "bravo!";
...
// $nbre = readline("Merci d'écrire un nombre et nous afficherons les 10 nombres suivants ");
// $nbre11 = $nbre + 10;

// while ($nbre != null && ($nbre < ($nbre11) )){
//           echo ++$nbre . "\n";
//     }
